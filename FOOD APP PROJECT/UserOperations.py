...
class UserOperations:
    ...
    def load_food_items(self):
            with open(r'C:\Users\rabin\OneDrive\Pictures\Documents\ppppp\edyoda\FOOD APP PROJECT\FoodItems.json', 'r') as file:
                self.data= json.load(file)
    def write_food_items(self,data):
        with open(r'C:\Users\rabin\OneDrive\Pictures\Documents\ppppp\edyoda\FOOD APP PROJECT\orderHistory.json','w') as addfile:
    ...
    def placeOrder(self):
       ...
       if not self.selected_items:
            ...
            with open(r'C:\Users\rabin\OneDrive\Pictures\Documents\ppppp\edyoda\FOOD APP PROJECT\orderHistory.json','r') as file:
    ...
    def updateProfile(self):
        ...
        with open(r'C:\Users\rabin\OneDrive\Pictures\Documents\ppppp\edyoda\FOOD APP PROJECT\details.json', 'r') as file:
        ...
        for credit in credentials:
            if credit['name']==self.name:
                ...
                with open(r'C:\Users\rabin\OneDrive\Pictures\Documents\ppppp\edyoda\FOOD APP PROJECT\details.json','w') as w:
...
if __name__ == "__main__":
    user_operations = UserOperations("rabin")
